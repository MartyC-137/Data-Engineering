...
-- Description: Script to set up a warehouse, 
-- role and user with basic privileges
/******************************************************************************/
...
grant usage on all schemas in database identifier($db_name) to role identifier(
    $role_name
);
grant select on all tables in database identifier($db_name) to role identifier(
    $role_name
);

/* Future Grants */
grant select on future tables in database identifier(
    $db_name
) to role identifier($role_name);
grant usage on future schemas in database identifier(
    $db_name
) to role identifier($role_name);
